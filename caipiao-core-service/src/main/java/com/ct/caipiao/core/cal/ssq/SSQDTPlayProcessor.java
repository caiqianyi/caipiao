...
@Service("ssqDtPlayProcessor")
public class SSQDTPlayProcessor extends AbstractSSQPlayProcessor implements
		ILotteryPlayService {

	public static final int MAX_DAN_NUMBER = 6;// 最大胆码数

	public static final int MAX_TUO_NUMBER = 16;// 最大拖码数

	public static final int MIN_DT_NUMBER = 7;
