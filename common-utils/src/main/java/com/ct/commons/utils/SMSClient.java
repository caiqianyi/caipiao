...
public static String  sentActivityNotice(String tel) {
	try {
		SMSClient client = new SMSClient("SDK-WSS-010-09866", "198-3c2[");
		GenerateCode gc = new GenerateCode();
		String rrid = gc.gen(8)+"";
		String result_mt = client.mdsmssend(tel, "通知：代理后台地址变更为：www.xianlaihy.com，给各位带来的不便深表歉意，谢谢谅解！【闲徕娱乐】", "", "", rrid, "");
		return result_mt;
