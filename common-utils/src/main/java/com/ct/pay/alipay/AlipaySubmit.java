...
public class AlipaySubmit {
     ...
     * @return 签名结果字符串
     */
	public static String buildRequestMysign(Map<String, String> sPara,String serverCode) {
     ...
     * @return 要请求的参数数组
     */
    private static Map<String, String> buildRequestPara(Map<String, String> sParaTemp,String server_code) {
        //除去数组中的空值和签名参数
     ...
     * @return 提交表单HTML文本
     */
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName,String server_code) {
        //待请求参数数组
